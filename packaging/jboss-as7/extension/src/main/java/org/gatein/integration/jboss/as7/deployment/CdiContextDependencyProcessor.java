...
public class CdiContextDependencyProcessor implements DeploymentUnitProcessor {
    ...
    private void addCdiContexts(DeploymentUnit deploymentUnit, ModuleSpecification moduleSpecification,
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        addCdiContexts(deploymentUnit, moduleSpecification, moduleLoader);
